...
PositionUtils.Conversion = {
   ...
   * @param  {CardinalDirection} positionData position data in cardinal format.
   ...
   * @param  {CartesianPortPosition} cartesianPct position data in cartesian format.
   * @return {CardinalPortPosition} position data in cardinal format.
   */
