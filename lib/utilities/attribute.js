...
var prepareValue = function(name, value, opts, force, onInit) {
  ...
  if (validate.call(this, name, value, opts, config) === false) {
 ...
 */
var validate = function(name, value, opts) {
  var config = this._attrConfigs[name];
 ...
 * @private
 */
setAttr = function(name, value, opts, force, onInit) {
...
Attribute.prototype = {
  ...
  set: function(name, val, opts) {
    return setAttr.call(this, name, val, opts);
  },
  ...
  _set: function(name, val, opts) {
    return setAttr.call(this, name, val, opts, true);
  },
